	...
	)
{
	...
	/*prptr->qcount = 0;	/* Initialize count of message queue to zero 
	prptr->qhead = 0;	/* Set head and 			     
	prptr->qtail = -1;      /*   and tail of queue			     
	prptr->ntopic = 0;	/* No of topics subscribed */
