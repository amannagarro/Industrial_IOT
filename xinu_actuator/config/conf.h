...
#define LED_RED     26       /* type actuator */
#define LED_GREEN   27       /* type actuator */
#define LED_BLUE    28       /* type actuator */
#define OBJ_SENSOR  29       /* type digital_sensor */
#define TMP_SENSOR  30       /* type analog_sensor */
...
#define	Nspi	2
#define	Nactuator	3
#define	Ndigital_sensor	1
#define	Nanalog_sensor	1
